...
- Vault configured on one of the EC2 servers (ubuntu):
![alt text](vault-1.png)
- Vault secret fetched and added as a tag on another EC2 instance using Terraform:
![alt text](vault-2.png)
- Vault server and another instance:
![alt text](vault-3.png)